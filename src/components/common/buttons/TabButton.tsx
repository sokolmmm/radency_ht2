...
function TabButton({
  ...
  return (
    <button
      ...
      className={`font-mono font-semibold text-lg shadow-2xl uppercase ease-in-out transition-transform hover:bg-teal-700 hover:text-white active:translate-y-2
